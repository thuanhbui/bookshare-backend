...
INSERT INTO eBook(eBookId, title, description, imageLink, fileLink, language, releaseYear, lastUpdate, viewers, catalogId, userId)
VALUES('3', 'Nếu Tôi Biết Được Khi Còn 20', '“Rất ít người cố gắng làm đủ mọi điều để nuôi dưỡng tư tưởng cách tân như Tina Seelig. Những nguyên tắc trong cuốn sách của cô chắc chắn sẽ làm bật lên nhiều ý tưởng mới mẻ. Đây thật sự là một cuốn sách rất cần thiết cho thế hệ doanh nhân mới, và cho cả những ai đã dạn dày trận mạc.” – David Kelley, nhà sáng lập của IDEO.', 'neu-toi-biet-duoc-khi-con-20.png', 'neu-toi-biet-duoc-khi-con-20.pdf','Việt Nam', null, '2001-06-23', 0, 4, 1);
INSERT INTO eBook(eBookId, title, description, imageLink, fileLink, language, releaseYear, lastUpdate, viewers, catalogId, userId)
