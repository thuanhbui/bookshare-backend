...
public class SqlDML {
    ...
    private static final String CATALOG_CACHE = SqlDML.class.getSimpleName() + "catalog";
    private static final String BOOK_CACHE = SqlDML.class.getSimpleName() + "book";
    private static final String BOOKSHELF_CACHE = SqlDML.class.getSimpleName() + "bookshelf";
    ...
    public static void main(String[] args) throws Exception {
        try (Ignite ignite = Ignition.start("examples/config/example-ignite.xml")) {
            ...
            CacheConfiguration<Long, Catalog> personCacheCfg = new CacheConfiguration<>(PERSON_CACHE);
     ...
     */
    private static void insert(IgniteCache<Integer, Catalog> orgCache, IgniteCache<Long, Catalog> personCache) {
     ...
     * @param personCache Person cache.
     */
    private static void update(IgniteCache<Long, Catalog> personCache) {
        String sql =
     ...
     * @param personCache Person cache.
     */
    private static void delete(IgniteCache<Long, Catalog> personCache) {
     ...
     * @param msg Message.
     */
    private static void select(IgniteCache<Long, Catalog> personCache, String msg) {
        String sql =
            "select p.id, concat(p.firstName, ' ', p.lastName), o.name, p.resume, p.salary " +
            "from Person as p, \"" + CATALOG_CACHE + "\".Organization as o " +
            "where p.orgId = o.id";
